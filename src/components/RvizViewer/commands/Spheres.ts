/**
 * Spheres 命令
 * 完全基于 regl-worldview 的 Spheres.js 实现
 */
...
const northPole: [number, number, number] = [0, 0, RADIUS]
const southPole: [number, number, number] = [0, 0, -RADIUS]
...
export default function Spheres(_props: { children: SphereList[] }) {
  return spheres
}
