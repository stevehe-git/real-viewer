...
import ViewControlPanel from './viewer-ctrl/ViewControlPanel.vue'
import SceneInfoPanel from './scene-info/SceneInfoPanel.vue'
import ToolPanel from './tools/ToolPanel.vue'
import DisplayPanel from './displays/DisplayPanel.vue'
import RobotConnectionPanel from './robot-connect/RobotConnectionPanel.vue'
import FloatingPanel from '../float-panel/FloatingPanel.vue'
import ImageViewerPanel from './displays/image/ImageViewerPanel.vue'
